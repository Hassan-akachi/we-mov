...
class TempDB {
  ...
  static List<BusRoute> tableRoute = [
    BusRoute(routeId: 1, routeName: 'Lagos-Abuja', cityFrom: 'Lagos', cityTo: 'Abuja', distanceInKm: 250),
    BusRoute(routeId: 2, routeName: 'Abuja-Lagos', cityFrom: 'Abuja', cityTo: 'Lagos', distanceInKm: 250),
  ];
